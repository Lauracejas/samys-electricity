  ...
  return (
    <>
      <div className="heroPic ">
        ...
        <div className="backOpacity card col-md-4 position-absolute top-60 end-0  align-items-center">
          <h4 className="leter"> Samy's Electrical Service </h4>
      ...
      <div className="Container-fluid content">
        <div className="row first">
          ...
          <img src={Photo} alt="home1" className="col-md-5 homePic /hd.jpg 1920w, /md.jpg 800w, /xs.jpg 400w" />
        </div>
