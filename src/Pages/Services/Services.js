...
const Services = () => {
  return (
    ...
    <div className=" services">
      ...
      <div className="row containers horizontal ">
        ...
        <div className="icons col-sd-4">
          ...
          <div class="icons col-sd-4">
            <Link to="/Project"><svg id="servicePainting" height="87" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 286.87 390.24"><title>Painting</title><g><path d="M283.42 28.11h-35.51V7.92A8 8 0 00240 0H7.92A8 8 0 000 7.92v68a8 8 0 007.92 7.88H240a8 8 0 007.92-7.92V52h15.94v74s.43 2.35-1.41 2.78-116.93 51.76-134.11 59.42c-1.39.62-2.13 1-2.13 3.1v42.22h-21.73v16.82h4.43v120.42s0 19.48 26.12 19.48 26.12-19.48 26.12-19.48V250.35h4.43v-16.83h-20.16v-25a2.21 2.21 0 011.46-2.29l138.8-63.36a2.25 2.25 0 001.18-2.29V31.19a2.9 2.9 0 00-3.44-3.07" fill="#fff"></path></g></svg>
            <span>Painting</span>
            </Link>
            </div>
